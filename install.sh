...
echo "   - Configure Named Ports:"
echo "     * name: http-web, port: 8008"
echo "     * name: http-api, port: 9009"
echo ""
...
echo ""
echo "3. Configure Backend Services (Create Two):"
echo "   a. Frontend Service:"
echo "      - Instance Group: Your Group (named port: http-web)"
echo "      - Enable Cloud CDN (recommended)"
echo "      - Enable IAP (Identity-Aware Proxy)"
echo "   b. Backend API Service:"
echo "      - Instance Group: Your Group (named port: http-api)"
echo "      - Enable IAP (Identity-Aware Proxy)"
echo ""
echo "4. URL Map (Routing Rules):"
echo "   - Path: /api/*  -> Route to 'Backend API Service'"
...
echo "   - Path: /*      -> Route to 'Frontend Service'"
echo ""
