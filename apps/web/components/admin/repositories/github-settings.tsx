...
export function GitHubSettings() {
  ...
  const handleTestConnection = async () => {
    ...
    try {
      setIsTesting(true);
      await api.testGitHubConnection({
      ...
      <form onSubmit={handleSave}>
        ...
        >
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            >
              Your GitHub username or organization name to scan repositories
              from.
            </small>
          </div>
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            >
              Name of the environment variable containing your GitHub personal
              access token.
            </small>
          </div>
      ...
      >
        ...
        >
          <li>
            ...
            <code style={{ backgroundColor: "#fff", padding: "2px 4px" }}>
              repo
            </code>{" "}
            scope
          </li>
          <li>
            Set the token as an environment variable (e.g.,{" "}
            <code style={{ backgroundColor: "#fff", padding: "2px 4px" }}>
