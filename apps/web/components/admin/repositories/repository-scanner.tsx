...
export function RepositoryScanner() {
  const triggerRepositoryRefresh = useWikiStore(
    (state) => state.triggerRepositoryRefresh,
  );
          ...
          <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1rem" }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "2px",
                cursor:
                  isCloning || selectedRepos.size === 0
                    ? "not-allowed"
                    : "pointer",
                fontSize: "0.875rem",
            ...
            >
              ...
              {isCloning
                ? "Cloning..."
                : `Clone Selected (${selectedRepos.size})`}
            </button>
          </div>
          ...
          >
            ...
            >
              <input
                type="checkbox"
                checked={
                  selectedRepos.size === filteredRepositories.length &&
              ...
              filteredRepositories.map((repo) => (
                <label
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    backgroundColor: selectedRepos.has(repo.full_name)
                      ? "#f0f7ff"
                      : "white",
                  }}
                  onMouseEnter={(e) => {
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      ...
                      {repo.private ? (
                        <Lock
                          size={14}
                          style={{ color: "#54595d", flexShrink: 0 }}
                        />
                      ) : (
                        <Globe
                          size={14}
