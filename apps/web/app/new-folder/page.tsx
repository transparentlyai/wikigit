  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(
          `Error creating folder: ${error.detail || "Unknown error"}`,
        );
      }
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        >
          Use forward slashes (/) to create nested folders. Do not include a
      ...
      <div style={{ display: "flex", gap: "12px" }}>
        ...
        <button onClick={handleCancel} className="btn" disabled={isCreating}>
          Cancel
        </button>
      </div>
    </div>
